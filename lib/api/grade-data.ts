...
export const mockEvaluationTypes: EvaluationTypeOption[] = [
  ...
  },
  {
    ...
    code: EvaluationType.TP,
    description: "Évaluation en TP",
    default_weight: 0.2,
  },
  {
    id: "eval-oral",
    name: "Oral",
    code: EvaluationType.ORAL,
    description: "Évaluation orale",
    default_weight: 0.2,
  },
  {
    id: "eval-exam",
    name: "Examen",
    code: EvaluationType.EXAM,
    description: "Examen final du cours",
    default_weight: 0.5,
  },
];

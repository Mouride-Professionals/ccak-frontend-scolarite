          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <span className={`mt-1 inline-flex rounded-full px-2 py-1 text-xs font-medium ${faculty.is_active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}>
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-900">{new Date(faculty.created_at).toLocaleString("fr-FR")}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-zinc-500">Mise à jour le</p>
                <p className="mt-1 text-sm text-zinc-900">{new Date(faculty.updated_at).toLocaleString("fr-FR")}</p>
              </div>
            </div>
          </div>
        </div>

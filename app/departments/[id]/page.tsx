        ...
        <DashboardLayout title="Détails du Département">
          <div className="flex min-h-[400px] items-center justify-center">
            <div className="text-center">
              ...
              <p className="mt-3 text-sm text-zinc-500">Chargement du département...</p>
            </div>
          </div>
        </DashboardLayout>
      </ProtectedRoute>
      ...
      <DashboardLayout title="Détails du Département">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-zinc-200 bg-white p-6">
            <h3 className="mb-4 text-base font-bold uppercase tracking-wide text-zinc-900">Informations générales</h3>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <span className={`mt-1 inline-flex rounded-full px-2 py-1 text-xs font-medium ${department.is_active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-900">{department.head?.name || "Non assigné"}</p>
              </div>
              <div>
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-6">
            <h3 className="mb-4 text-base font-bold uppercase tracking-wide text-zinc-900">Métadonnées</h3>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                <p className="text-sm font-medium text-zinc-500">Créé le</p>
                <p className="mt-1 text-sm text-zinc-900">{new Date(department.created_at).toLocaleString("fr-FR")}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-zinc-500">Mis à jour le</p>
                <p className="mt-1 text-sm text-zinc-900">{new Date(department.updated_at).toLocaleString("fr-FR")}</p>
              </div>
            </div>
          </div>
        </div>

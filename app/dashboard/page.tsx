  ...
  return (
    <ProtectedRoute>
      <DashboardLayout title="Tableau de bord">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-zinc-900">Bienvenue sur CCAK - Back Office</h2>
        ...
        <div className="mt-8 grid grid-cols-12 gap-6">
          ...
          <div className="col-span-6">
            <Card
              ...
              rightSlot={
                <select
                  className="text-xs border border-slate-400 rounded-md px-2 py-1"
                  defaultValue="6 derniers mois"
                ></select>
              }
            >

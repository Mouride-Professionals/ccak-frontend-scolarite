            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-amber-800">
                  Les résultats des étudiants ne sont disponibles que pour les délibérations avec le statut <strong>COMPLETED</strong> ou <strong>CLOSED</strong>.
                </p>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-4">
              ...
              <div>
                ...
                <p className="mt-1 text-2xl font-bold text-red-600">
                  {resultsData.data.filter(r => r.decision === DeliberationDecision.FAILED).length}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium text-zinc-500">En attente</p>
                <p className="mt-1 text-2xl font-bold text-amber-600">
                  {resultsData.data.filter(r => r.decision === null || r.decision === DeliberationDecision.RESIT).length}
                </p>
              </div>
            </div>
          </div>
                      ...
                      <td className="px-4 py-3">
                        {hasResult && result.jury_remarks ? (
                          <div className="flex items-start gap-2">
                            ...
                            <p className="text-sm text-zinc-700 line-clamp-2" title={result.jury_remarks}>
                              {result.jury_remarks}
                            </p>
                          </div>
                        ) : (

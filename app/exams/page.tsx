...
export default function ExamsPage() {
  ...
  const activeFilterCount = [filters.status, filters.type, filters.semester_number].filter(
    Boolean
  ).length;
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters((prev) => ({
                      ...prev,
                      status: (e.target.value as ExamSessionStatus) || undefined,
                      page: 1,
                    }))
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters((prev) => ({
                      ...prev,
                      type: (e.target.value as ExamSessionType) || undefined,
                      page: 1,
                    }))
                  }
                  className="block w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm focus:border-[#008D36] focus:outline-none focus:ring-1 focus:ring-[#008D36]"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters((prev) => ({
                      ...prev,
                      semester_number: e.target.value ? parseInt(e.target.value) : undefined,
                      page: 1,
                    }))
                  }
                  className="block w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm focus:border-[#008D36] focus:outline-none focus:ring-1 focus:ring-[#008D36]"
        ...
        {error ? (
          ...
          <div className="flex min-h-[300px] flex-col items-center justify-center rounded-lg border border-dashed border-zinc-300 bg-white">
            ...
            {!isReadOnly && (
              <Link
                href="/exams/new"
                className="mt-3 text-sm font-medium text-[#008D36] hover:underline"
              >
                Créer une session →
              </Link>
            )}

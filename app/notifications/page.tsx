        ...
        <div className="flex border-b border-gray-200 mb-8 overflow-x-auto">
          {["Tous", "Notification", "Annonce"].map((tab) => (
            <button
              ...
              className={`pb-3 px-4 text-sm font-medium mr-4 transition-colors whitespace-nowrap ${
                activeTab === tab
              ...
              <div className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div className="flex items-center gap-4 overflow-hidden">
                  {/* CORRECTION AVATAR : 
                            ...
                            */}
                  <div
                    className={`h-10 w-10 flex-shrink-0 rounded-full flex items-center justify-center ${notif.avatarColor}`}
                  >
                  ...
                  <div className="text-sm min-w-0">
                    ...
                    <span className="text-gray-400 text-xs block sm:inline">• {notif.time}</span>
                  </div>
                </div>
